def look_for_first_n_distinct_characters(signal: str, n: int) -> int:
    buffer = []
    for ch in signal:
        buffer.append(ch)
...
def part_one(signal: str) -> int:
    ...
    return look_for_first_n_distinct_characters(signal, 4)


def part_two(signal: str) -> int:
    """Lorem ipsum dolor sit amet"""
    return look_for_first_n_distinct_characters(signal, 14)
