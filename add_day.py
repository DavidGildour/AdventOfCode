...
parser.add_argument("-l", "--lang", type=str, default="py", choices=["py", "go"], help="a programming language to generate a template for")
...
def create_boilerplate(year: int, day: int, language: str) -> str:
    ...
    with open(solution, "w") as output_file, open(f"templates/{language}.template") as template_file:
