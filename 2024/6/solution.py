...
parser = argparse.ArgumentParser(description="Solution for Advent of Code 6/2024.")
...
if __name__ == "__main__":
    ...
    if args.test:
        ...
        print("Running 2024/6 solution on test input.")
    else:
        filename = "./input.txt"
        print("Running 2024/6 solution on full input.")
