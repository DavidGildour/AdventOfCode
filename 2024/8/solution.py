...
parser = argparse.ArgumentParser(description="Solution for Advent of Code 8/2024.")
...
if __name__ == "__main__":
    ...
    if args.test:
        ...
        print("Running 2024/8 solution on test input.")
    else:
        filename = "./input.txt"
        print("Running 2024/8 solution on full input.")
