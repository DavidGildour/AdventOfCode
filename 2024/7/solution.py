...
parser = argparse.ArgumentParser(description="Solution for Advent of Code 7/2024.")
...
if __name__ == "__main__":
    ...
    if args.test:
        ...
        print("Running 2024/7 solution on test input.")
    else:
        filename = "./input.txt"
        print("Running 2024/7 solution on full input.")
