...
parser = argparse.ArgumentParser(description="Solution for Advent of Code 9/2024.")
...
if __name__ == "__main__":
    ...
    if args.test:
        ...
        print("Running 2024/9 solution on test input.")
    else:
        filename = "./input.txt"
        print("Running 2024/9 solution on full input.")
