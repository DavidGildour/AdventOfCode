...
def part_one(cave_passages: list[str]) -> int:
    ...
    """
    cave_system = CaveSystem(cave_passages)
    cave_system.get_all_possible_routes()

    return len(cave_system.routes)


def part_two(cave_passages: list[str]) -> int:
    ...
    """
    cave_system = CaveSystem(cave_passages)
    cave_system.get_all_possible_routes(with_new_rules=True)
