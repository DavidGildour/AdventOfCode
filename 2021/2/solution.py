...
from models import Position, AimedPosition, Movement, Course
...
def move_forth_aimed(position: AimedPosition, move: Movement) -> AimedPosition:
    if move.direction == FORWARD:
...
def part_one(course: Course) -> int:
    ...
    """
    position = reduce(move_forth, course, Position())
    return position.horizontal * position.depth


def part_two(course: Course) -> int:
    ...
    """
    position = reduce(move_forth_aimed, course, AimedPosition())
    return position.horizontal * position.depth
...
if __name__ == '__main__':
    ...
    position_prod = part_two(submarine_course)
    print(f"PART TWO: The position product is {position_prod}.")
