def part_one(depths: list[int]) -> int:
    ...
    """
    return len([diff for a, b in zip(depths, depths[1:]) if (diff := b - a) > 0])
...
if __name__ == '__main__':
    ...
    increases = part_one(parsed_depths)
    print(f"PART ONE: The ocean floor increased {increases} number of times.")
    increases = part_two(parsed_depths)
    print(f"PART TWO: The ocean floor increased {increases} number of times.")
